  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-4 lg:grid-cols-12 gap-4 p-4 lg:gap-6 min-h-screen">
        ...
        action={
          <div className="flex gap-2">
            <div className="flex items-center gap-1 text-[10px] text-zinc-500">
              <div className="size-2 rounded-full bg-blue-500"></div>Focus Hours
            </div>
            <div className="flex items-center gap-1 text-[10px] text-zinc-500">
              <div className="size-2 rounded-full bg-white/10"></div>Goal
            </div>
          </div>
        }
      >
      ...
      >
        <Link
          href="/logs/new"
          className="flex flex-col items-center justify-center h-full min-h-[120px] py-6 text-center bg-white/5 rounded-lg border border-white/5 cursor-pointer hover:bg-white/10 transition-colors group/diary gap-2"
        >
