...
export function WorkBalance() {
  ...
  const { mutate: updateWasteMutation, isPending: wastePending } = useMutation({
  ...
  const workHours = Math.max(balance.workHours, 15 - wasteHours);
