  ...
  return (
    <div className="space-y-4">
            ...
            <div className="mt-1 flex size-2 items-center justify-center">
              <div
                className={`size-2 rounded-full ${
                  task.status === "PENDING" ? "bg-amber-500" : "bg-green-500"
                }`}
              />
            </div>
      ...
      <button
        ...
        className="w-full text-center text-xs text-zinc-500 hover:text-white transition-colors pt-2 cursor-pointer"
      >
        View All Tasks
      </button>
    </div>
