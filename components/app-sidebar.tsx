    ...
    >
      ...
      <SidebarContent>
        <SidebarGroup className="group-data-[collapsible=icon]:p-0!">
          <SidebarGroupLabel className="text-zinc-500 tracking-wider text-[10px] uppercase font-bold mt-2 mb-2">
            Platform
          </SidebarGroupLabel>
            ...
            {navMain.map((item) => (
              <SidebarMenuItem key={item.title}>
                ...
                >
                  <a
                    href={item.url}
                    className="flex items-center gap-4 px-4 w-full group-data-[collapsible=icon]:px-0 group-data-[collapsible=icon]:justify-center"
                  >
                    <item.icon className="size-5" />
                    <span className="font-semibold tracking-wide text-sm group-data-[collapsible=icon]:hidden">
                      {item.title}
                    </span>
                  </a>
                </SidebarMenuButton>
